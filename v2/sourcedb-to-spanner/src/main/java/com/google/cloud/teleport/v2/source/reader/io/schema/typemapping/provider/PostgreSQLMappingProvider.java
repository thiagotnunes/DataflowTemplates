...
public final class PostgreSQLMappingProvider {
  private static final ImmutableMap<String, UnifiedTypeMapping> MAPPING =
      ImmutableMap.<String, UnifiedMappingProvider.Type>builder()
          ...
          .put("INT2", UnifiedMappingProvider.Type.LONG)
          .put("INT4", UnifiedMappingProvider.Type.LONG)
          ...
          .put("SERIAL2", UnifiedMappingProvider.Type.LONG)
          .put("SERIAL4", UnifiedMappingProvider.Type.LONG)
          .put("SERIAL8", UnifiedMappingProvider.Type.LONG)
          .put("SMALLINT", UnifiedMappingProvider.Type.LONG)
          .put("SMALLSERIAL", UnifiedMappingProvider.Type.LONG)
